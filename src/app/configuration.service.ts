...
export class ConfigurationService {
  ...
  readonly aboutText1 : string = "Tester auto sales is a family owned small business of 15 years. We are here to treat you like family when buying your next motor vehicle.";
  readonly aboutText2 : string = "More text here. More text here. More text here. More text here. More text here. More text here. More text here. More text here. More text here. More text here. More text here. More text here. More text here. More text here. More text here. More text here. More text here. More text here. More text here. More text here. More text here. More text here.";
